...
// Debug: Check if guru ID is found
if ($current_guru_id === null) {
    // If no guru record found, try to get all activities for debugging
    echo "<!-- Debug: No guru ID found for user_id: $current_user_id -->";
    // You might want to create the guru record automatically here
...
if ($current_guru_id !== null) {
    $param_count++;
    $where_conditions[] = "k.id_guru = $$param_count";
    $params[] = $current_guru_id;
} else {
    echo "<!-- Debug: No guru record found, showing all activities for debugging -->";
}
...
if (!empty($search)) {
    $param_count++;
    $where_conditions[] = "(jk.nama_kegiatan ILIKE $$param_count OR CONCAT(kl.tingkat, ' ', kl.jurusan) ILIKE $$param_count)";
    $params[] = "%$search%";
    $params[] = "%$search%";
    $param_count++;
}
...
<head>
    ...
    <title>Lihat Kegiatan - Portal Guru</title>
    ...
    <!-- Adding custom CSS for stronger table borders -->
    <style>
        .table-bordered {
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="false">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder text-white mb-0">Kegiatan Saya</h6>
                </nav>
                        ...
                        <div class="card-body">
                            <form method="GET" class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="search" class="form-control" placeholder="Cari kegiatan atau kelas..." value="<?php echo htmlspecialchars($search); ?>">
                                </div>
                                <div class="col-md-2">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                <!-- Added table-bordered class for visible borders -->
                                            ...
                                            <tr>
                                                <td colspan="7" class="text-center py-4">
                                                    <div class="text-center">
                                                        ...
                                                        <?php if ($current_guru_id === null): ?>
                                                            <p class="text-sm text-secondary mb-0">Akun guru belum terdaftar di sistem</p>
                                                            <p class="text-xs text-muted">Silakan hubungi administrator untuk mendaftarkan akun Anda</p>
                                                        <?php else: ?>
                                                            <p class="text-sm text-secondary mb-0">Tidak ada kegiatan ditemukan</p>
                                                            <p class="text-xs text-muted">Coba ubah filter atau tambah kegiatan baru</p>
                                                        <?php endif; ?>
                                                    </div>
                                                </td>
                                            </tr>
